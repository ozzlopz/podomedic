...
export function getWorkingRangesForDay(day: number, schedule?: Partial<WeeklySchedule> | null): TimeRange[] {
...
export function getAvailableSlotsForDay(day: number, exclusions: TimeRange[] = [], schedule?: Partial<WeeklySchedule> | null) {
  const workingRanges = getWorkingRangesForDay(day, schedule);
